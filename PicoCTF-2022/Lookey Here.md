...
## Writeup
When we first download the text, we get this:
```
      ANTHEM
...
our
    ...
    We are sitting at a table and we are writing this upon paper made
      ...
      EGO
```
Woah, that's some long text! We can use grep to see if there exists a flag via this command: `cat anthem.flag.txt | grep pico`
